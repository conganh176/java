...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("6 is the perfect number: " + isPerfectNumber(6));
        System.out.println("28 is the perfect number: " + isPerfectNumber(28));
        System.out.println("5 is the perfect number: " + isPerfectNumber(5));
        System.out.println("-1 is the perfect number: " + isPerfectNumber(-1));
    }
